...
class NeuroEvolution:
    ...
    def _lamarck_steps(self) -> int:
        return self._lamarck.steps

    @_lamarck_steps.setter
    def _lamarck_steps(self, value: int) -> None:
        self._lamarck.steps = value

    @property
    def _lamarck_sigma(self) -> float:
        return self._lamarck.sigma

    @_lamarck_sigma.setter
    def _lamarck_sigma(self, value: float) -> None:
        self._lamarck.sigma = value

    @property
    def _lamarck_max_steps(self) -> int:
        return self._lamarck.max_steps

    @_lamarck_max_steps.setter
    def _lamarck_max_steps(self, value: int) -> None:
        self._lamarck.max_steps = value

    @property
    def _lamarck_top_k(self) -> float:
        return self._lamarck.top_k

    @_lamarck_top_k.setter
    def _lamarck_top_k(self, value: float) -> None:
        self._lamarck.top_k = value

    @property
    def _lamarck_n_applied(self) -> int:
        return self._lamarck.n_applied

    @_lamarck_n_applied.setter
    def _lamarck_n_applied(self, value: int) -> None:
        self._lamarck.n_applied = value

    @property
    def _lamarck_n_steps_total(self) -> int:
        return self._lamarck.n_steps_total

    @_lamarck_n_steps_total.setter
    def _lamarck_n_steps_total(self, value: int) -> None:
        self._lamarck.n_steps_total = value

    @property
    def _lamarck_time_ms(self) -> float:
        return self._lamarck.time_ms

    @_lamarck_time_ms.setter
    def _lamarck_time_ms(self, value: float) -> None:
        self._lamarck.time_ms = value

    @property
    def _lamarck_n_blocked_top_k(self) -> int:
        return self._lamarck.n_blocked_top_k

    @_lamarck_n_blocked_top_k.setter
    def _lamarck_n_blocked_top_k(self, value: int) -> None:
        self._lamarck.n_blocked_top_k = value
